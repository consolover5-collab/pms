        ...
        <div className="grid md:grid-cols-2 gap-6">
          <div data-testid="help-booking-statuses">
            ...
            <div className="space-y-1 text-sm">
              <div className="flex items-center gap-2">
                ...
                <span>{t(dict, "help.status.confirmed")}</span>
              </div>
              <div className="flex items-center gap-2">
                <span className="w-3 h-3 bg-green-500 rounded-full"></span>
                <span>{t(dict, "help.status.checkedIn")}</span>
              </div>
              <div className="flex items-center gap-2">
                <span className="w-3 h-3 bg-gray-400 rounded-full"></span>
                <span>{t(dict, "help.status.checkedOut")}</span>
              </div>
              <div className="flex items-center gap-2">
                <span className="w-3 h-3 bg-red-500 rounded-full"></span>
                <span>{t(dict, "help.status.cancelled")}</span>
              </div>
              <div className="flex items-center gap-2">
                <span className="w-3 h-3 bg-yellow-500 rounded-full"></span>
                <span>{t(dict, "help.status.noShow")}</span>
              </div>
            </div>
          </div>
          ...
          <div data-testid="help-room-statuses">
            ...
            <div className="space-y-1 text-sm">
              <div className="flex items-center gap-2">
                <span className="w-3 h-3 bg-green-500 rounded-full"></span>
                <span>{t(dict, "help.status.clean")}</span>
              </div>
              <div className="flex items-center gap-2">
                <span className="w-3 h-3 bg-red-500 rounded-full"></span>
                <span>{t(dict, "help.status.dirty")}</span>
              </div>
              <div className="flex items-center gap-2">
                <span className="w-3 h-3 bg-blue-500 rounded-full"></span>
                <span>{t(dict, "help.status.inspected")}</span>
              </div>
              <div className="flex items-center gap-2">
                <span className="w-3 h-3 bg-gray-700 rounded-full"></span>
                <span>{t(dict, "help.status.outOfOrder")}</span>
              </div>
            </div>
          </div>
        </div>
