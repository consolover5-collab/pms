...
async function seed() {
  ...
  const guestData = [
    { propertyId: property.id, firstName: "FN470", lastName: "LN470", email: "qwwixhpmik@hifqxmakjr.com", phone: "+78624065146", nationality: "DE", gender: "M", language: "en", vipStatus: "SILVER" },
    { propertyId: property.id, firstName: "FN1086", lastName: "LN1086", email: "nuvaxtqfdl@vqbgsrhhtm.com", phone: "+57231554221", nationality: "RU", gender: "F", language: "ru", vipStatus: "SILVER" },
    { propertyId: property.id, firstName: "FN568", lastName: "LN568", email: "motbsxbaov@bkdexfspzo.com", phone: "+35491178301", nationality: "RU", gender: "F", language: "ru", vipStatus: "GOLD" },
    { propertyId: property.id, firstName: "FN2070", lastName: "LN2070", email: "lcunsfgfey@seurjwqugg.com", phone: "+03687170473", nationality: "RU", gender: "F", language: "ru", vipStatus: "GOLD" },
    { propertyId: property.id, firstName: "FN802", lastName: "LN802", email: "evxoafhupn@dzfsaodebr.com", phone: "+10163015218", nationality: "RU", gender: "M", language: "ru", vipStatus: "VIP" },
    { propertyId: property.id, firstName: "FN869", lastName: "LN869", email: "hhvmqamgzf@mmdsndbcsa.com", phone: "+38642417843", nationality: "RU", gender: "F", language: "ru", vipStatus: "VIP" },
    { propertyId: property.id, firstName: "FN254", lastName: "LN254", email: "ntgfaoezmn@hrtzyjshru.com", phone: "+95296882573", nationality: "RU", gender: "M", language: "ru", vipStatus: "VIP" },
    { propertyId: property.id, firstName: "FN1749", lastName: "LN1749", email: "slctobadiv@fufzpuoqfp.com", phone: "+53662234244", nationality: "PL", gender: "M", language: "en", vipStatus: "SILVER" },
    { propertyId: property.id, firstName: "FN5946", lastName: "LN5946", email: "qxkmwnmaqb@sptlmcgufj.com", phone: "+81184237969", nationality: "RU", gender: "M", language: "ru", vipStatus: "VIP" },
    { propertyId: property.id, firstName: "FN7162", lastName: "LN7162", email: "vexfsovrpo@cbrbichbuv.com", phone: "+42678577858", nationality: "RU", gender: "M", language: "ru", vipStatus: "VIP" },
  ];
